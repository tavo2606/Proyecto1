 ...
 * @author Tavo
 */
public class MenuAdminCatPeli extends javax.swing.JFrame {

    /**
     * Creates new form MenuAdminCatPeli
     */
    public MenuAdminCatPeli() {
        initComponents();
    ...
    private void btnMostarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMostarActionPerformed
        MenuAdminCatPeliMost v = new MenuAdminCatPeliMost();
        v.setVisible(true);
    }//GEN-LAST:event_btnMostarActionPerformed

    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        MenuAdminCatPeliAgre v = new MenuAdminCatPeliAgre();
        v.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuAdminCatPeli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuAdminCatPeli().setVisible(true);
            }
        });
    }
