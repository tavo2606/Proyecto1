 ...
 * @author Tavo
 */
public class MenuAdminCatMusicaMost extends javax.swing.JFrame {

    /**
     * Creates new form MenuAdminCatMost
     */
    public MenuAdminCatMusicaMost() {
        initComponents();
    ...
    private void llenarTabla(){
        // Cambios en la tabla
        String[] columnas = new String[] {"Nombre Álbum", "Autor", "Categoría", "Precio", "Lista Canciones", "Cantidad"}; // columnas de la tabla
        ...
        try{
            ...
            while( (linea = lector.readLine()) != null ){
                String nom, aut, cate, cancio, preci, canti;
                nom = linea.split(" ")[0].replaceAll("_", " ");
                aut = linea.split(" ")[1].replaceAll("_", " ");
                cate = linea.split(" ")[2];
                preci = linea.split(" ")[3];
                cancio = linea.split(" ")[4].replaceAll("_", "");
                canti = linea.split(" ")[5];
                modelo.addRow(new Object[]{nom, aut, cate, preci, cancio, canti});
            }
        }catch(Exception e){
    ...
    private void initComponents() {
        ...
        setTitle("Catálogo de música[Mostrar]");
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuAdminCatMusicaMost.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuAdminCatMusicaMost().setVisible(true);
            }
        });
    }
