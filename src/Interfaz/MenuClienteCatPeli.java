...
public class MenuClienteCatPeli extends javax.swing.JFrame {
    ...
    private void preorden(String prodcuto, ArrayList<String> listaPreOrden){
        try{
            ...
            String archivo = "PrePeli.txt";
            FileWriter fw = new FileWriter(archivo, true);
            BufferedWriter bw = new BufferedWriter(fw);
            PrintWriter pw = new PrintWriter(bw);
            
            FileReader fr = new FileReader("PrePeli.txt");
            BufferedReader lector = new BufferedReader(fr);
            ...
            String newPreOrden = prodcuto.replaceAll(" ", "_") + " " + "Tipo:Película" + " " + countEquals(prodcuto, listaPreOrden);
