 ...
 * @author Tavo
 */
public class MenuAdminCatMusicaElim extends javax.swing.JFrame {

    /**
     * Creates new form MenuAdminCatMusicaElim
     */
    public MenuAdminCatMusicaElim() {
        initComponents();
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if(opc == JOptionPane.YES_OPTION){
            ...
            JOptionPane.showMessageDialog(null, "Elemento borrado del catálogo", "Eliminar",JOptionPane.INFORMATION_MESSAGE);
        }else{
            JOptionPane.showMessageDialog(null, "Elemento no borrado del catálogo", "Eliminar", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuAdminCatMusicaElim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuAdminCatMusicaElim().setVisible(true);
            }
        });
    }
